  ...
  const jobs = [
    {
      ...
      featured: true,
      description:
        "Tuyển dụng chuyên viên Backend để phát triển hệ thống quản lý doanh nghiệp...",
      requirements: [
    ...
    },
    {
      ...
      featured: false,
      description:
        "Cần tuyển nhân viên thiết kế giao diện người dùng cho các dự án ứng dụng di động...",
      requirements: [
        "2+ năm kinh nghiệm thiết kế",
        "Thành thạo Figma",
        "Hiểu biết UX research",
      ],
    ...
    },
    {
      ...
      featured: true,
      description:
        "Tuyển dụng kỹ sư DevOps để quản lý hạ tầng và triển khai tự động...",
      requirements: [
    ...
    },
    {
      ...
      featured: false,
      description:
        "Tuyển nhân viên marketing số để quản lý chiến dịch quảng cáo trực tuyến...",
      requirements: [
        "2+ năm kinh nghiệm marketing",
        "Thành thạo SEO",
    ...
    },
    {
      ...
      featured: true,
      description:
        "Cần tuyển chuyên viên phân tích dữ liệu để hỗ trợ ra quyết định kinh doanh...",
      requirements: [
        "3+ năm kinh nghiệm phân tích",
        "Thành thạo SQL",
    ...
    },
    {
      ...
      featured: false,
      description:
        "Tuyển dụng lập trình viên mobile để phát triển ứng dụng cho iOS và Android...",
      requirements: [
        "2+ năm kinh nghiệm với Flutter",
        "Thành thạo Dart",
        "Hiểu biết về Android",
      ],
      benefits: ["Lương linh hoạt", "Hỗ trợ thiết bị", "Thưởng dự án"],
    },
  ];
              ...
              <CardContent className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {job.tags.map((tag) => (
                    <Badge
                      ...
                      label={tag}
                      variant="secondary"
                      className="text-xs bg-orange-500 text-white font-medium"
                    />
                  ))}
                </div>
                ...
                <div className="flex items-center justify-between">
                  <Badge
                    label={job.type}
                    variant={
                      job.type === "Toàn thời gian" ? "default" : "outline"
                    }
                    className={
                  ...
                  <Button
                    ...
                    onClick={() =>
                      handleApplyClick({} as React.MouseEvent, job)
                    }
                  >
                    Apply Now
                  </Button>
...
function useApp(): { navigateTo: (route: string, params?: { job?: Job }) => void } {
  return {
    navigateTo: (route: string, params?: { job?: Job }) => {
      // Example navigation logic using window.location or a router
      if (route === "jobs-detail" && params?.job) {
        // Navigate to job detail page with job id
        window.location.href = `/jobs/${params.job.id}`;
      } else if (route === "jobs") {
